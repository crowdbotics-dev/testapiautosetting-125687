...
## Project Structure
    ...
    ├── testapiautosetting_125687  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125687`
...
2. Clone this repo and `cd testapiautosetting_125687`
